...
const ContactsCountGraph = () => {
	...
	async function fetchData(queryParams: any) {
		const response = await fetch(
			'http://89.111.155.61:9001/api/v1/rating?fieldType=ALL&size=1000&calculationType=FORMS&toDate=' +
				queryParams.toDate,
			{
				headers: {
